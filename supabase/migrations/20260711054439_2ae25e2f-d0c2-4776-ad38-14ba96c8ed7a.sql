...
BEGIN
  ...
  IF _pool = 'frame' THEN
    INSERT INTO _pool_items(slug, name, image_url, rarity) VALUES
      ...
      ('rainbow','Arcoíris',NULL,'legendario'),('art-wings','Alas celestiales',NULL,'legendario'),('art-crown','Corona real',NULL,'legendario'),('art-dragon','Dragón dorado',NULL,'legendario'),('art-lotus-red','Loto rojo',NULL,'legendario'),('art-lotus-blue','Loto azul',NULL,'legendario'),
      ('z-demon','Portal demoníaco',NULL,'z'),('z-cosmic','Fénix cósmico',NULL,'z'),('z-blood','Sangre eterna',NULL,'z'),('z-skull-hands','Guardianes óseos',NULL,'z'),('z-viking','Casco de Odín',NULL,'z');
