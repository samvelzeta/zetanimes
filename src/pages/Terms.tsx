    ...
    <div className="min-h-screen px-4 py-8 pb-24 max-w-3xl mx-auto">
      ...
      <div className="prose prose-sm prose-invert max-w-none space-y-6 text-muted-foreground">
        <section>
          ...
          <p>Al acceder y utilizar ZetAnime, aceptas cumplir con estos términos. ZetAnime es una plataforma de entretenimiento que permite a los usuarios explorar, buscar y ver contenido anime.</p>
        ...
        <section>
          <h2 className="text-lg font-bold text-foreground">4. Contenido</h2>
          <p>ZetAnime no aloja directamente contenido audiovisual. Actuamos como agregador de enlaces y fuentes de terceros. No nos hacemos responsables del contenido proporcionado por servidores externos.</p>
          <p>Todo el contenido mostrado pertenece a sus respectivos autores, estudios y distribuidores.</p>
        </section>
        ...
        <section>
          <h2 className="text-lg font-bold text-foreground">9. Modificaciones</h2>
